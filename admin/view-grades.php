        ...
        $i = 0; 
          ...
          ?>
                    <tr>
                      ...
                      <td><button data-toggle="modal" data-target="#editModal<?php echo $i; ?>" class="btn btn-primary">Edit <i class="fas fa-edit"></i></button></td>
                    </tr>
<!-- Modal -->
<div class="modal fade" id="editModal<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit <?php echo $grade['student_name']; ?>'s Grade</h5>
  ...
  <input type="hidden" name="student_no" value="<?php echo $grade['student_no']; ?>">
  <input type="hidden" name="grade_id" value="<?php echo $grade['id']; ?>">
  <div class="form-group">
    <label for="exampleInputEmail1">Grade</label>
    <input type="number" name="grade" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $grade['grade']; ?>">
  </div>
        <button type="submit" name="edit_grade" class="btn btn-primary">Edit Grade <i class="fas fa-edit"></i></button>
      </form>
      </div>
