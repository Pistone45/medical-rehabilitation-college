...
<div class="row container-fluid">
  ...
  <!-- Basic Card Example -->
    <div class="card shadow mb-4">
      ...
      <label>Select Class</label>
            <select class="custom-select" name="classes_id" onchange="showModule(this.value)" id="class_id" required="">
  ...
  <div class="col-md-5">
    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 28rem;" src="../images/undraw_teaching_f1cm.svg" alt="">
  </div>
</div>
