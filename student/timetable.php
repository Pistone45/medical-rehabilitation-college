...
$getTimetableEntriesPerStudent = new Settings();
$timetables = $getTimetableEntriesPerStudent->getTimetableEntriesPerStudent($classes_id);
        ...
        if(isset($timetables) && count($timetables)>0){ 
          ...
          <?php
                ...
                <?php
                        ...
                        echo "No Calendar Entries Available";
                      }
        ?>
              </div>
      </div>
